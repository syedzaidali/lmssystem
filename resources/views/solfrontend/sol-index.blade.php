                    ...
                    <div class="main-banner-wrapper">
                        <div class="banner-style-one owl-theme owl-carousel">
                            <div class="slide slide-one"
                                style="background-image: url({{ asset('sol-assets/images/home/1.jpg') }}); height: 95vh;">
                                <div class="container">
                            ...
                            <div class="slide slide-one"
                                style="background-image: url({{ asset('sol-assets/images/home/2.jpg') }}); height: 95vh;">
                                <div class="container">
                                    <div class="row home-content">
                                        <div class="col-lg-12 text-center p0">
                                            <h3 class="banner-title">Self EducatIon Resources and Infos</h3>
                            ...
                            <div class="slide slide-one"
                                style="background-image: url({{ asset('sol-assets/images/home/3.jpg') }}); height: 95vh;">
                                <div class="container">
                                    <div class="row home-content">
                                        <div class="col-lg-12 text-center p0">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="testimonialsec">
                        <ul class="tes-nav">
                            <li>
                                <img class="img-fluid" src="{{ asset('sol-assets/images/testimonial/1.jpg') }}"
                                    alt="1.jpg" />
                            </li>
                            <li>
                                <img class="img-fluid" src="{{ asset('sol-assets/images/testimonial/2.jpg') }}"
                                    alt="2.jpg" />
                            </li>
                            <li>
                                <img class="img-fluid" src="{{ asset('sol-assets/images/testimonial/3.jpg') }}"
                                    alt="3.jpg" />
                            </li>
                            <li>
                                <img class="img-fluid" src="{{ asset('sol-assets/images/testimonial/4.jpg') }}"
                                    alt="4.jpg" />
                            </li>
                        </ul>
                        <ul class="tes-for">
                    ...
                    <div class="blog_slider_home1">
                        <div class="item">
                            <div class="blog_post one">
                                <div class="thumb">
                                    ...
                                    <img class="img-fluid w100" src="{{ asset('sol-assets/images/blog/1.jpg') }}"
                                        alt="1.jpg">
                        ...
                        <div class="item">
                            <div class="blog_post one">
                                <div class="thumb">
                                    <div class="post_title">Events</div>
                                    <img class="img-fluid w100" src="{{ asset('sol-assets/images/blog/1a.jpg') }}"
                                        alt="1a.jpg">
                                    <a class="post_date" href="#"><span>28 <br> March</span></a>
                                </div>
                                <div class="details">
                        ...
                        <div class="item">
                            <div class="blog_post one">
                                <div class="thumb">
                                    <div class="post_title">Events</div>
                                    <img class="img-fluid w100" src="{{ asset('sol-assets/images/blog/1b.jpg') }}"
                                        alt="1b.jpg">
                                    <a class="post_date" href="#"><span>28 <br> March</span></a>
                                </div>
                                <div class="details">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="phone_img">
                        <img class="img-fluid" src="{{ asset('sol-assets/images/resource/phone_home.png') }}"
                            alt="phone_home.png">
                    </div>
                </div>
            </div>
