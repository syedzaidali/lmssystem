...
<div class="container">
    ...
    <a class="btn btn-success" href="javascript:void(0)" id="createNewProduct"> Create New Sub Categoeies</a>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="status" id="status">
                            <option value="">Select Categoires</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" id="heading" name="heading" required="" placeholder="Enter Heading" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
