                                ...
                                <div class="courses_single_container">
                                    <div class="cs_row_one">
                                        <div class="cs_ins_container">
                                            <div class="cs_instructor">
                                                <ul class="cs_instrct_list float-left mb0">
                                                    <li class="list-inline-item"><img class="thumb"
                                                            src="{{ asset('sol-assets/images/team/4.png') }}" alt="4.png">
                                                    </li>
                                            ...
                                            <h3 class="cs_title">{{$responseBody[0]->name}}</h3>
                                            ...
                                            <div class="courses_big_thumb">
                                                <div class="thumb video">
                                                    <video width="960" height="552" controls>
                                                        <source src="{{$responseBody[0]->video_url}}" type="video/mp4">
                                                        ...
                                                        <div id="panelBodyCourseStart" class="panel-collapse collapse show">
                                                            <div class="panel-body">
                                                                <ul class="cs_list mb0">
                                                                    ...
                                                                    Lecture {{ $loop->index +1}}. {{$res->name}}<span class="cs_time">{{$res->video_duration}}</span> <span
                                            ...
                                            {{-- <div class="details">
                                                <div id="accordion" class="panel-group cc_tab">
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                <a href="#panelBodyCourseBrief"
                                                                    class="accordion-toggle link" data-toggle="collapse"
                                                                    data-parent="#accordion">The
                                                                    Brief</a>
                                                            </h4>
                                                        </div>
                                                        ...
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                <a href="#panelBodyCourseLow" class="accordion-toggle link"
                                                                    ...
                                                                    data-parent="#accordion">Wireframing
                                                                    Low Fidelity</a>
                                                            </h4>
                                                        </div>
                                                        ...
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                <a href="#panelBodyCourseType" class="accordion-toggle link"
                                                                    data-toggle="collapse" data-parent="#accordion">Type,
                                                                    Color
                                                                    & Icon Introduction</a>
                                                            </h4>
                                                        </div>
                                    ...
                                    <div class="cs_row_four">
                                        <div class="about_ins_container">
                                            ...
                                            <div class="about_ins_info">
                                                <div class="thumb"><img src="{{ asset('sol-assets/images/team/6.png') }}"
                                                        alt="6.png"></div>
                                            </div>
                                            <div class="details">
                                                ...
                                                <ul class="about_info_list">
                                                    ...
                                                    <li class="list-inline-item"><span
                                                            class="flaticon-play-button-1"></span>
                                                        5Courses </li>
                                                </ul>
                                                <h4>Ali Tufan</h4>
                                                ...
                                                <p class="mb25">UI/UX Designer, with 7+ Years Experience. Guarantee of High
                                                    Quality Work. </p>
                                                <p class="mb25">Skills: Web Design, UI Design, UX/UI Design, Mobile Design,
                                                    User
                                                    Interface Design, Sketch, Photoshop, GUI, Html, Css, Grid Systems,
                                                    Typography, Minimal, Template, English, Bootstrap, Responsive Web
                                                    Design,
                                                    Pixel Perfect, Graphic Design, Corporate, Creative, Flat, Luxury and
                                                    much
                                                    more.</p>
                                        ...
                                        <div class="sfeedbacks">
                                            ...
                                            <div class="mbp_pagination_comments">
                                                <div class="mbp_first media csv1">
                                                    <img src="{{ asset('sol-assets/images/resource/review1.png') }}"
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p class="fz15 mt20">This is the second Photoshop course I have
                                                            ...
                                                            highly.
                                                            To get the most out of this course, its best to to take the
                                                            Beginner
                                                        ...
                                                        <div class="mbp_sub media csv1">
                                                            <a href="#"><img
                                                                    src="{{ asset('sol-assets/images/resource/review1.png') }}"
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <p class="fz15 mt20 mb50">This is the second Photoshop
                                                                    ...
                                                                    recommend it highly. To get the most out of this course,
                                                                    its
                                                ...
                                                <div class="mbp_second media csv1">
                                                    <img src="{{ asset('sol-assets/images/resource/review1.png') }}"
                                                        class="align-self-start mr-3" alt="review1.png">
                                                    <div class="media-body">
                                                        <h4 class="sub_title mt-0">Warren Bethell
                                                            <span class="sspd_review float-right">
                                                                <ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-xl-4">
                                <div class="top_courses">
                                    <div class="thumb">
                                        <img class="img-whp" src="{{ asset('sol-assets/images/courses/t1.jpg') }}"
                                            alt="t1.jpg">
                                        <div class="overlay">
                            ...
                            <div class="col-lg-6 col-xl-4">
                                <div class="top_courses">
                                    <div class="thumb">
                                        <img class="img-whp" src="{{ asset('sol-assets/images/courses/t2.jpg') }}"
                                            alt="t2.jpg">
                                        <div class="overlay">
                            ...
                            <div class="col-lg-6 col-xl-4">
                                <div class="top_courses">
                                    <div class="thumb">
                                        <img class="img-whp" src="{{ asset('sol-assets/images/courses/t3.jpg') }}"
                                            alt="t3.jpg">
                                        <div class="overlay">
                                            <div class="tag">Top Seller</div>
                                            <div class="icon"><span class="flaticon-like"></span></div>
                    ...
                    <div class="col-lg-4 col-xl-3">
                        <div class="instructor_pricing_widget">
                            ...
                            <ul class="price_quere_list text-left">
                                <li><a href="#"><span class="flaticon-play-button-1"></span> 11 hours on-demand video</a>
                                </li>
