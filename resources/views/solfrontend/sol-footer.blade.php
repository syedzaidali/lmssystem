			...
			<div class="row">
				<div class="col-sm-4 col-md-3 col-lg-3 col-xl-2 pb15 pt15">
					<div class="logo-widget home1">
						<img class="img-fluid" src="{{asset('sol-assets/images/logos.png')}}" alt="header-logos.png">
						<!-- <span>EDUMY</span> -->
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-6 offset-lg-3">
					<div class="copyright-widget text-center">
						<p>Copyright Solmax Group © 2021. All Rights Reserved.</p>
					</div>
				</div>
			</div>
		</div>
