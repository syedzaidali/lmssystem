                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
                                <h4 class="title float-left">Child Catagoery</h4>
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">Sub Categories</label>
                            <div class="col-sm-12">
                                <input type="hidden" id="categories_id" name="categories_id" value="1" required=""
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('childcategories.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
            ...
            $('body').on('click', '.editProduct', function() {
                ...
                $.get("{{ route('childcategories.index') }}" + '/' + product_id + '/edit', function(data) {
                    $('#modelHeading').html("Edit Product");
                    $('#saveBtn').val("edit-user");
                    $('#ajaxModel').modal('show');
                    $('#product_id').val(data.id);
                    $('#sub_categories_id').val(data.sub_categories_id);
                    $('#name').val(data.name);
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('childcategories.store') }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deleteProduct', function() {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('childcategories.store') }}" + '/' + product_id,
                    success: function(data) {
                        table.draw();
                    },
                    error: function(data) {
