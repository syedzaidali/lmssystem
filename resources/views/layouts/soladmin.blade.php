		...
		<div class="container-fluid">
		    ...
		    <nav>
		        ...
		        <div class="menu-toggle">
		            <img class="nav_logo_img img-fluid" src="{{asset('sol-assets/images/logos.png')}}" height="40px" width="240px" alt="header-logos.png">
		        ...
		        <a href="#" class="navbar_brand float-left dn-smd">
						            <img class="logo1 img-fluid" src="{{asset('sol-assets/images/logos.png')}}" height="40px" width="240px" alt="header-logos.png">
		        ...
		        <ul class="header_user_notif pull-right dn-smd">
	                ...
	                <li class="user_setting">
						<div class="dropdown">
	                		<a class="btn dropdown-toggle" href="#" data-toggle="dropdown"><img class="rounded-circle" src="{{asset('sol-assets/images/team/e1.png')}}" alt="e1.png"></a>
						    <div class="dropdown-menu">
						    	<div class="user_set_header">
						    		<img class="float-left" src="{{asset('sol-assets/images/team/e1.png')}}" alt="e1.png">
							    	<p>Kim Hunter <br><span class="address"><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4d26242025382339283f0d2a202c2421632e2220">[email&#160;protected]</a></span></p>
						    	</div>
		...
		<div class="mobile-menu">
                ...
                <li class="user_setting">
					<div class="dropdown">
					    ...
					    <div class="dropdown-menu">
					    	<div class="user_set_header">
					    		<img class="float-left" src="{{asset('sol-assets/images/team/e1.png')}}" alt="e1.png">
						    	<p>Kim Hunter <br><span class="address"><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b4dfddd9dcc1dac0d1c6f4d3d9d5ddd89ad7dbd9">[email&#160;protected]</a></span></p>
					    	</div>
					    	<div class="user_setting_content">
								<a class="dropdown-item active" href="#">My Profile</a>
								<a class="dropdown-item" href="#">Messages</a>
			...
			<div class="header stylehome1 dashbord_mobile_logo dashbord_pages">
				<div class="main_logo_home2">
		            <img class="nav_logo_img img-fluid float-left mt20" src="{{asset('sol-assets/images/logos.png')}}" height="35px" width="210px" alt="header-logos.png">
...
<!-- Wrapper End -->
<script type="text/javascript" src="sol-assets/js/jquery-3.3.1.js"></script>
